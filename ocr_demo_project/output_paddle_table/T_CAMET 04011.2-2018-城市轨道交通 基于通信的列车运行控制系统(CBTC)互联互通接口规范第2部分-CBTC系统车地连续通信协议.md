...
[
  ...
  },
  {
    "信息域定义": "数据版本校验信息",
    "字节编号": "11",
    "字段": "ZC与V0BC之间的版本一致性信息",
    "长度": "4字节",
    "信息位定义及说明": "ZC管辖范围内,ZC与V0BC间的数据版本校验信息"
  },
  {
    "信息域定义": "数据版本校验信息",
    "字节编号": "12",
...
[
  {
    ...
    "字段": "序列号",
    "长度": "4字节",
    "信息位定义及说明": "记录收到对方上一条消息中的对方消息序列号默认值：0xFFFFFFF"
  },
  {
    "信息域定义": "对方消息序列号b",
    "字节编号": "22",
  ...
  {
    "信息域定义": "收到上一条消息时本方序列号b",
    "字节编号": "25",
    "字段": "协议版本号",
    "长度": "4字节",
    "信息位定义及说明": "记录收到对方上一条消息时，本方的周期计数默认值：0xFFFFFFF"
  },
  {
    "信息域定义": "收到上一条消息时本方序列号b",
    "字节编号": "26",
  ...
  },
  {
    ...
    "字段": "应用层数据长度",
    "长度": "2字节",
    "信息位定义及说明": "ZC/V0BC的协议版本，本规范定义为20"
  },
  {
    "信息域定义": "应用层数据长度",
    "字节编号": "30",
  ...
  {
    "信息域定义": "注：1.数据版本校验计算范围为ZC管辖区域范围；2.ZC/V0BC判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。b序列号有效值为1~（21-1）。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔“当未收到对方消息时，填写默认值。",
    "字节编号": "注：1.数据版本校验计算范围为ZC管辖区域范围；2.ZC/V0BC判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。b序列号有效值为1~（21-1）。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔“当未收到对方消息时，填写默认值。",
    "字段": "注：1.数据版本校验计算范围为ZC管辖区域范围；2.ZC/V0BC判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。b序列号有效值为1~（21-1）。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔“当未收到对方消息时，填写默认值。",
    "长度": "注：1.数据版本校验计算范围为ZC管辖区域范围；2.ZC/V0BC判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。b序列号有效值为1~（21-1）。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔“当未收到对方消息时，填写默认值。",
    "信息位定义及说明": "注：1.数据版本校验计算范围为ZC管辖区域范围；2.ZC/V0BC判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。b序列号有效值为1~（21-1）。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔“当未收到对方消息时，填写默认值。"
  }
]
...
[
  {
    "接口内容": "下一ZC ID",
    "字节长度": "4",
    "说明": "ZC IDMA终点到ZC边界或者越过ZC边界时设定该信息默认值:0x00000000如到达线路终端,填写默认值",
    "是否安全信息": "非安全信息"
  },
  {
    "接口内容": "MA信息",
    "字节长度": "2",
    "说明": "MA信息长度从“MA方向”位到“信号机状态”所有字节长度有效范围:49~429",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "MA信息",
    "字节长度": "1",
    "说明": "MA方向在MA起点朝向MA终点的方向,以MA起点处的上下行方向定义确定上行:0x55,下行:0xAA其他非法",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "MA信息",
    "字节长度": "1",
    "说明": "停车保证请求有:0x55,无:0xAA其他非法停车保证功能可选,根据工程项目需求确定,如无此功能则默认填写无停车保证请求",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "MA信息",
    "字节长度": "4",
    "说明": "停车保证请求序列号有效范围:1~(2²⁻¹-1)默认值:0xFFFFFFF",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "14",
...
[
  ...
  },
  {
    "接口内容": "MA信息",
    "字节长度": "4",
    "说明": "区段内偏移量,单位:cm有效范围:0x0~0xFFFFFFE"
  },
  {
    "接口内容": "MA信息",
    "字节长度": "—",
  ...
  },
  {
    "接口内容": "MA信息",
    "字节长度": "4",
    "说明": "轨道区段ID默认值:0x00000000"
  },
  {
    "接口内容": "MA信息",
    "字节长度": "4",
    "说明": "区段内偏移量,单位:cm有效范围:0x0~0xFFFFFFE默认值:0xFFFFFFFF"
  },
  {
    "接口内容": "MA信息",
    "字节长度": "1",
    "说明": "保护区段有效性(保护区段建立时有效)有效:0x55无效:0xAA默认值:0xFF",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "路径信息",
    "字节长度": "2",
    "说明": "道岔信息个数(MA内包含的道岔,个数为变量,有效范围:0~20)d",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "路径信息",
...
[
  ...
  },
  {
    "接口内容": "路径信息",
    "字节长度": "—",
    "说明": "道岔(X)信息,X是道岔信息个数字段取值",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "PSD状态",
    "字节长度": "2",
    "说明": "PSD信息数(MA内包含的PSD,个数为变量,有效范围:0~10)",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "PSD状态",
  ...
  },
  {
    "接口内容": "PSD状态",
    "字节长度": "1",
    "说明": "PSD状态非关闭且锁闭:0x55关闭且锁闭:0xAA互锁解除:0xCC其他非法若ZC无互锁解除相关功能,可将互锁解除视为“关门”处理"
  },
  {
    "接口内容": "PSD状态",
    "字节长度": "...",
  ...
  },
  {
    "接口内容": "PSD状态",
    "字节长度": "—",
    "说明": "PSD(Y)信息,Y是PSD信息个数字段取值",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "ESB状态",
    "字节长度": "2",
    "说明": "ESB信息个数(MA内包含的ESB,个数为变长,有效范围:0~10)",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "ESB状态",
...
[
  {
    "接口内容": "ESB状态*",
    "字节长度": "—",
    "说明": "ESB(Z)信息,Z是ESB信息个数字段取值"
  },
  {
    "接口内容": "无人折返按钮状态",
    "字节长度": "1",
    "说明": "无人折返按钮状态(列车停靠无人折返站台时发送) 按下:0x55,未按下:0xAA(默认值)",
    "是否安全信息": "非安全信息"
  },
  {
    "接口内容": "临时限速信息*",
    "字节长度": "2",
    "说明": "临时限速信息个数(个数为变长,有效范围:0~10)",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "临时限速信息*",
  ...
  },
  {
    "接口内容": "临时限速信息*",
    "字节长度": "4",
    "说明": "区间中偏移量,单位:cm有效范围:0x0~0xFFFFFE"
  },
  {
    "接口内容": "临时限速信息*",
    "字节长度": "—",
  ...
  },
  {
    "接口内容": "临时限速信息*",
    "字节长度": "1",
    "说明": "临时限速值:单位:km/h(0km/h~254km/h)0xFF;默认值",
    "是否安全信息": "安全信息"
  },
  {
    "接口内容": "临时限速信息*",
  ...
  },
  {
    "接口内容": "ZC-ZC通信延迟",
    "字节长度": "2",
    "说明": "计算跨边界点MA时,ZC与相邻ZC的通信延时,单位:ms有效范围:0~10 000",
    "是否安全信息": "安全信息"
  }
]
...
[
  {
    "接口内容": "注册/注销响应",
    "字节长度": "1",
    "说明": "注册成功:0x55,注册失败:0xAA注销成功:0xCC其他非法",
    "使用方式": "非安全信息"
  },
  {
    "接口内容": "注册失败原因",
    "字节长度": "1",
    "说明": "错误代码0x**:注册失败原因(根据业主要求定义)0xFF:默认值,注册成功或注销成功时填写",
    "使用方式": "非安全信息"
  },
  {
    "接口内容": "预留",
...
[
  ...
  {
    "接口内容": "注1：“ZC主动注销请求”包与“列车控制信息”包、“特殊控制报文”包在同一GAL包中不应同时存在。注2：ZC发送“ZC主动注销请求”包后，应持续发送“ZC主动注销请求”包，不接受VOBC发送的除“注销信息包”外的其他信息，直至收到VOBC发送的“注销信息包”或判断通信超时。注3：VOBC收到“ZC主动注销请求”包后，应向ZC发送“注销信息包”。",
    "字节长度": "注1：“ZC主动注销请求”包与“列车控制信息”包、“特殊控制报文”包在同一GAL包中不应同时存在。注2：ZC发送“ZC主动注销请求”包后，应持续发送“ZC主动注销请求”包，不接受VOBC发送的除“注销信息包”外的其他信息，直至收到VOBC发送的“注销信息包”或判断通信超时。注3：VOBC收到“ZC主动注销请求”包后，应向ZC发送“注销信息包”。",
    "说明": "注1：“ZC主动注销请求”包与“列车控制信息”包、“特殊控制报文”包在同一GAL包中不应同时存在。注2：ZC发送“ZC主动注销请求”包后，应持续发送“ZC主动注销请求”包，不接受VOBC发送的除“注销信息包”外的其他信息，直至收到VOBC发送的“注销信息包”或判断通信超时。注3：VOBC收到“ZC主动注销请求”包后，应向ZC发送“注销信息包”。",
    "使用方式": "注1：“ZC主动注销请求”包与“列车控制信息”包、“特殊控制报文”包在同一GAL包中不应同时存在。注2：ZC发送“ZC主动注销请求”包后，应持续发送“ZC主动注销请求”包，不接受VOBC发送的除“注销信息包”外的其他信息，直至收到VOBC发送的“注销信息包”或判断通信超时。注3：VOBC收到“ZC主动注销请求”包后，应向ZC发送“注销信息包”。"
  }
]
...
[
  {
    "接口内容": "特殊控制报文",
    "字节长度": "1",
    "说明": "紧急制动命令有命令:0x55无命令:0xAA其他:非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "特殊控制报文",
  ...
  {
    "接口内容": "注1:“特殊控制报文”包与“列车控制信息”包在同一GAL包内不应同时存在。注2:非注销过程中,不满足发送“列车控制信息”的条件,应发送特殊控制报文包。注3:ZC判断不需列车紧急制动,但需保持链路时,发送特殊控制报文包,且“紧急制动命令”字段取值为“无命令”。注4:当V0BC收到的特殊控制报文中“紧急制动命令”字段为“无命令”时,应不因此原因发生紧急制动,并保持与ZC的安全连接。",
    "字节长度": "注1:“特殊控制报文”包与“列车控制信息”包在同一GAL包内不应同时存在。注2:非注销过程中,不满足发送“列车控制信息”的条件,应发送特殊控制报文包。注3:ZC判断不需列车紧急制动,但需保持链路时,发送特殊控制报文包,且“紧急制动命令”字段取值为“无命令”。注4:当V0BC收到的特殊控制报文中“紧急制动命令”字段为“无命令”时,应不因此原因发生紧急制动,并保持与ZC的安全连接。",
    "说明": "注1:“特殊控制报文”包与“列车控制信息”包在同一GAL包内不应同时存在。注2:非注销过程中,不满足发送“列车控制信息”的条件,应发送特殊控制报文包。注3:ZC判断不需列车紧急制动,但需保持链路时,发送特殊控制报文包,且“紧急制动命令”字段取值为“无命令”。注4:当V0BC收到的特殊控制报文中“紧急制动命令”字段为“无命令”时,应不因此原因发生紧急制动,并保持与ZC的安全连接。",
    "使用方式": "注1:“特殊控制报文”包与“列车控制信息”包在同一GAL包内不应同时存在。注2:非注销过程中,不满足发送“列车控制信息”的条件,应发送特殊控制报文包。注3:ZC判断不需列车紧急制动,但需保持链路时,发送特殊控制报文包,且“紧急制动命令”字段取值为“无命令”。注4:当V0BC收到的特殊控制报文中“紧急制动命令”字段为“无命令”时,应不因此原因发生紧急制动,并保持与ZC的安全连接。"
  }
]
...
[
  {
    "接口内容": "运行方向a",
    "字节长度": "1",
    "说明": "最小安全后端指向最大安全前端的方向，以最小安全后端处的上下行方向确定上行：0x55",
    "使用方式": "安全信息"
  }
]
...
[
  ...
  },
  {
    "接口内容": "激活端",
    "字节长度": "1",
    "说明": "本V0BC是否为激活端(首尾冗余的V0BC统一发送是激活端)\n激活端:0x55\n非激活端:0xAA\n其他非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车包络线",
  ...
  },
  {
    "接口内容": "列车包络线",
    "字节长度": "4",
    "说明": "区段内偏移量,单位:cm,有效范围:0x0~0xFFFFFFF*\n默认值:0xFFFFFFF",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车包络线",
...
[
  {
    "接口内容": "列车包络线",
    "字节长度": "4",
    "说明": "轨道区段ID $ ^{a} $ 默认值:0x00000000",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车包络线",
    "字节长度": "4",
    "说明": "区段内偏移量,单位:cm,有效范围:0x0~0xFFFFFFE $ ^{a} $ 默认值:0xFFFFFFF",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车包络线",
    "字节长度": "2",
    "说明": "列车长度,单位:cm,有效范围:1000~50000",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车包络线",
    "字节长度": "2",
    "说明": "列车车头第一轮对到车钩长度(单位:cm),有效范围:1~1000",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车运行控制级别 $ ^{b} $",
    "字节长度": "1",
    "说明": "0x01:CBTC;0x02:点式;0x03:联锁控制级别;其他非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车驾驶模式 $ ^{b} $",
    "字节长度": "1",
    "说明": "0x01:AM;0x02:CM;0x03:RM;0x04:EUM;其他非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "车辆状态",
    "字节长度": "1",
    "说明": "停车保证响应 $ ^{c} $ 0x55:可以停车;0xAA:无法停车;0xFF:默认值;其他非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "车辆状态",
    "字节长度": "4",
    "说明": "停车保证响应序列号 $ ^{c} $ 有效范围:1~(2 $ ^{31} $ -1)默认值:0xFFFFFFF",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "车辆状态",
    "字节长度": "4",
    "说明": "停车保证对应安全防护点轨道区段ID $ ^{c} $ 默认值:0x00000000",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "车辆状态",
    "字节长度": "4",
    "说明": "停车保证对应安全防护点区段内偏移量,单位:cm,有效范围:0x0~0xFFFFFFF $ ^{c} $ 默认值:0xFFFFFFF",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "24",
...
[
  ...
  },
  {
    "接口内容": "车辆状态",
    "字节长度": "4",
    "说明": "停车保证对应障碍点区段内偏移量,单位:cm,有效范围:0x0~0xFFFFFFF $ ^{*} $ \n默认值:0xFFFFFFF",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "车辆状态",
  ...
  },
  {
    "接口内容": "车辆状态",
    "字节长度": "1",
    "说明": "折返状态(AR状态,折返时车尾OBC注册后,到折返流程完成之前的状态)\n0x55:AR状态;0xAA:非AR状态\n其他非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "车辆状态",
  ...
  },
  {
    "接口内容": "车辆状态",
    "字节长度": "1",
    "说明": "无人折返指示灯\n0x55:折返指示灯常亮\n0xAA:折返指示灯常灭\n0xCC:折返指示灯闪烁\n其他非法\n若地面设备无折返指示灯闪烁功能,可将折返指示灯闪烁作为常亮处理;若车载设备无折返指示灯闪烁功能,可不发送折返指示灯闪烁信息",
    "使用方式": "非安全信息"
  }
]
...
[
  {
    "接口内容": "车辆状态",
    "字节长度": "1",
    "说明": "紧急制动状态0x55:车载ATP采集到车辆反馈未实施紧急制动0xAA:车载ATP采集到车辆反馈已实施紧急制动其他:非法",
    "使用方式": "非安全信息"
  },
  {
    "接口内容": "列车速度/距离信息",
    "字节长度": "2",
    "说明": "列车速度,单位:cm/s有效范围:0~15 000",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车速度/距离信息",
    "字节长度": "1",
    "说明": "速度方向(车轮旋转的方向)0x55:前(停车时是向前)0xAA:后其他非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车速度/距离信息",
    "字节长度": "2",
    "说明": "退行距离,单位:cm最不利情况下,列车从开始退行到停车的走行距离。有效范围:1~5 000默认值:0xFFFF",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车速度/距离信息",
    "字节长度": "1",
    "说明": "停准停稳信息0x55:停准且停稳0xAA:未停稳0xCC:停稳但未停准其他:非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "列车速度/距离信息",
    "字节长度": "1",
    "说明": "保护区段允许解锁0x55:允许解锁0xAA:不允许解锁其他非法",
    "使用方式": "安全信息"
  },
  {
    "接口内容": "受控ZCID",
    "字节长度": "4",
    "说明": "受控ZC(列车采用MA/特殊控制报文的ZC)的ID默认值:0x00000000车载V0BC未采用MA和特殊控制报文时发送默认值",
    "使用方式": "安全信息"
  }
]
...
[
  ...
  {
    "EUM": "注：×/○表示该控制级别下不具有/具有该驾驶模式。",
    "RM": "注：×/○表示该控制级别下不具有/具有该驾驶模式。",
    "CM": "注：×/○表示该控制级别下不具有/具有该驾驶模式。",
    "AM": "注：×/○表示该控制级别下不具有/具有该驾驶模式。"
  }
]
...
[
  {
    "接口内容": "注册/注销请求",
    "字节长度": "1",
    "说明": "注册请求:0x55;注销请求:0xCC其他非法",
    "使用方式": "非安全信息"
  },
  {
    "接口内容": "注销原因",
    "字节长度": "1",
    "说明": "切换注销:0x01*和所有连接ZC注销:0x02其他原因:0xFF其他取值非法注册请求时,填写0xFF",
    "使用方式": "非安全信息"
  },
  {
    "接口内容": "预留",
  ...
  {
    "接口内容": "&quot;V0BC开始向ZC发送&quot;注册信息包&quot;时,由于此时V0BC未收到过ZC的信息,故&quot;注册信息包&quot;中,GAL包帧头中的&quot;对方消息序列号&quot;、&quot;收到上一条消息时本方序列号&quot;字段取值为默认值。ZC收到此类&quot;注册信息包&quot;后,无法判断该信息包是否超时,此时ZC应回复空GAL包(GAL包帧头中&quot;应用层数据长度&quot;为0,且无应用层数据),此空GAL包帧头中的&quot;对方消息序列号&quot;、&quot;收到",
    "字节长度": "&quot;V0BC开始向ZC发送&quot;注册信息包&quot;时,由于此时V0BC未收到过ZC的信息,故&quot;注册信息包&quot;中,GAL包帧头中的&quot;对方消息序列号&quot;、&quot;收到上一条消息时本方序列号&quot;字段取值为默认值。ZC收到此类&quot;注册信息包&quot;后,无法判断该信息包是否超时,此时ZC应回复空GAL包(GAL包帧头中&quot;应用层数据长度&quot;为0,且无应用层数据),此空GAL包帧头中的&quot;对方消息序列号&quot;、&quot;收到",
    "说明": "&quot;V0BC开始向ZC发送&quot;注册信息包&quot;时,由于此时V0BC未收到过ZC的信息,故&quot;注册信息包&quot;中,GAL包帧头中的&quot;对方消息序列号&quot;、&quot;收到上一条消息时本方序列号&quot;字段取值为默认值。ZC收到此类&quot;注册信息包&quot;后,无法判断该信息包是否超时,此时ZC应回复空GAL包(GAL包帧头中&quot;应用层数据长度&quot;为0,且无应用层数据),此空GAL包帧头中的&quot;对方消息序列号&quot;、&quot;收到",
    "使用方式": "&quot;V0BC开始向ZC发送&quot;注册信息包&quot;时,由于此时V0BC未收到过ZC的信息,故&quot;注册信息包&quot;中,GAL包帧头中的&quot;对方消息序列号&quot;、&quot;收到上一条消息时本方序列号&quot;字段取值为默认值。ZC收到此类&quot;注册信息包&quot;后,无法判断该信息包是否超时,此时ZC应回复空GAL包(GAL包帧头中&quot;应用层数据长度&quot;为0,且无应用层数据),此空GAL包帧头中的&quot;对方消息序列号&quot;、&quot;收到"
  }
]
...
[
  ...
  {
    "信息域定义": "*1.数据版本校验信息取值规则在工程阶段约定；2.ZC/ATS判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。*序列号有效值为1~(231-1)。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔。*当未收到对方消息时，填写默认值。",
    "字节编号": "*1.数据版本校验信息取值规则在工程阶段约定；2.ZC/ATS判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。*序列号有效值为1~(231-1)。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔。*当未收到对方消息时，填写默认值。",
    "字段": "*1.数据版本校验信息取值规则在工程阶段约定；2.ZC/ATS判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。*序列号有效值为1~(231-1)。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔。*当未收到对方消息时，填写默认值。",
    "长度": "*1.数据版本校验信息取值规则在工程阶段约定；2.ZC/ATS判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。*序列号有效值为1~(231-1)。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔。*当未收到对方消息时，填写默认值。",
    "信息位定义及说明": "*1.数据版本校验信息取值规则在工程阶段约定；2.ZC/ATS判断“数据版本校验信息”或“协议版本号”字段校验不通过时，应进行丢包或断开通信处理。*序列号有效值为1~(231-1)。发送方应保证生成两包信息包时，两包信息报中的“本方消息序列号”字段的差值与“通信周期”相乘等于生成两包消息的时间间隔。*当未收到对方消息时，填写默认值。"
  }
]
...
[
  {
    "接口内容": "年",
    "字节长度": "1",
    "说明": "有效范围11~99（表示2011~2099年），超出范围无效"
  },
  {
    "接口内容": "月",
    "字节长度": "1",
...
[
  {
    "接口内容": "服务号/表号",
    "字节长度": "2",
    "说明": "00~65 534 有效默认值:0xFFFF列车为非计划车时,发送默认值"
  },
  {
    "接口内容": "线路编号",
    "字节长度": "2",
  ...
  },
  {
    "接口内容": "下一ZC ID*",
    "字节长度": "4",
    "说明": "V0BC 最大安全前端所在 ZC 管辖区域的下一个 ZCID。“最大安全前端”的定义在具体工程项目中明确默认值为 0x00000000"
  },
  {
    "接口内容": "下一CI ID*",
    "字节长度": "4",
    "说明": "V0BC 最大安全前端所在 CI 管辖区域的下一个 CIID默认值为 0x00000000"
  },
  {
    "接口内容": "下一ATSID*",
    "字节长度": "4",
    "说明": "V0BC 最大安全前端所在 ATS 管辖区域的下一个 ATSID默认值为 0x00000000"
  },
  {
    "接口内容": "车组所属线路号",
    "字节长度": "2",
  ...
  },
  {
    "接口内容": "车组号",
    "字节长度": "2",
    "说明": "001~999 有效,超出范围无效“车组所属线路号”+“车组号”在全线网内为唯一标识"
  },
  {
    "接口内容": "源线路号",
    "字节长度": "2",
    "说明": "列车始发站线路编号,全网统一标识默认值:0xFFFF"
  },
  {
    "接口内容": "车次号",
    "字节长度": "2",
    "说明": "0001~9999 有效,超出范围无效,0000 为默认值"
  },
  {
    "接口内容": "目的地线路号",
    "字节长度": "2",
    "说明": "目的地线路编号,同线路编号默认值:0xFFFF列车无目的地号时,发送默认值"
  }
]
...
[
  {
    "接口内容": "目的地号",
    "字节长度": "4",
    "说明": "列车运行计划中列车运行的终点。用ASCII码表示，最多4个ASCII码，低于4个，高位使用空格补齐默认值：0xFFFFFFF列车为非计划车时，发送默认值具体定义方式在工程中明确"
  },
  {
    "接口内容": "计划运行方向",
    "字节长度": "1",
    "说明": "列车运行计划中，列车的运行方向上行：0x55；下行：0xAA；默认：0xFF；其他：非法"
  },
  {
    "接口内容": "跳停站台IDb",
    "字节长度": "4",
    "说明": "下一站跳停时，取值为站台ID，跳停站台只针对正常上下客站各设置。下一站不跳停时取值为0x00000000"
  },
  {
    "接口内容": "到站站台IDb",
    "字节长度": "4",
    "说明": "到达站站台ID；默认值：0x00000000"
  },
  {
    "接口内容": "下-停车站台IDb",
    "字节长度": "4",
    "说明": "前方最近的停车站台ID，定义同“跳停站台ID”，默认值为0x00000000"
  },
  {
    "接口内容": "站停时间",
    "字节长度": "2",
    "说明": "立即停车：0x50001站停时间：不小于0x0002，单位：s，有效范围：2~65534默认值：0xFFFF其他非法"
  },
  {
    "接口内容": "下一站跳停命令",
    "字节长度": "1",
    "说明": "下一站跳停：0x55下一站无跳停命令/取消下一站跳停：0xAA默认值：0xFF其他非法"
  },
  {
    "接口内容": "区间运行调整命令",
    "字节长度": "2",
    "说明": "运行等级或区间运行时间（发车到下一站停车），根据业主需求确定，在互联互通线网中应统一，如果区间运行调整命令为默认值，则按V0BC约定的默认运行曲线运行"
  }
]
...
[
  {
    "接口内容": "扣车命令 $ ^{e} $",
    "字节长度": "1",
    "说明": "扣车有效:0x55扣车取消,无扣车:0xAA默认值:0xFF其他非法"
  },
  {
    "接口内容": "扣车站台ID $ ^{f} $",
    "字节长度": "4",
    "说明": "扣车站台ID默认值:0x00000000若本站扣车,则发送本站ID;若本站不扣车或取消本站扣车,则发送默认值"
  },
  {
    "接口内容": "折返命令 $ ^{d} $",
    "字节长度": "1",
    "说明": "是否进行折返站前折返:0x55有人站后折返:0xCC无人自动折返:0xAA不折返:0x33默认值:0xFF"
  },
  {
    "接口内容": "回段指示 $ ^{e} $",
    "字节长度": "1",
    "说明": "是否进行回段。回段:0x55;不回段:0xAA;默认值:0xFF"
  },
  {
    "接口内容": "门控策略",
    "字节长度": "1",
    "说明": "开关门策略开左门,之后关左门:0x55开右门,之后关右门:0xCC同时开双侧门,之后同时关双侧门:0xAA先开左门再开右门之后同时关双侧门:0x11(开门间隔在具体工程项目中确认 $ ^{f} $ )先开右门再开左门之后同时关双侧门:0x22关双侧门:0x88;先开左门再关左门再开右门再关右门:0x33;先开右门再关右门再开左门再关左门:0x44;默认值:0xFF站台为双侧门时,发送门控策略,单侧门时发送默认值;左右门定义为按照沿列车进站方向的左、右侧"
  }
]
...
[
  {
    "2. 当列车最大安全前端在转换轨内且列车为回段方向时，对于计划列车，ATS根据列车运行计划，向VOBC发送“回段”或“不回段”指示，对于非计划列车，ATS向VOBC发送默认值。": "3. VOBC与ATS通信正常且收到的回段提示字段非默认值时，根据ATS回段提示信息，判断在转换轨内是否显示回段提示；VOBC与ATS通信断开或收到的回段提示字段为默认值时，根据电子地图配置的区段属性，在转换轨内显示回段提示。"
  },
  {
    "2. 当列车最大安全前端在转换轨内且列车为回段方向时，对于计划列车，ATS根据列车运行计划，向VOBC发送“回段”或“不回段”指示，对于非计划列车，ATS向VOBC发送默认值。": "本信息帧中涉及“站台ID”的字段，若命令对应位置两侧均为站台，则ATS可发送任意一侧站台ID。"
  },
  {
    "2. 当列车最大安全前端在转换轨内且列车为回段方向时，对于计划列车，ATS根据列车运行计划，向VOBC发送“回段”或“不回段”指示，对于非计划列车，ATS向VOBC发送默认值。": "对双侧车门不同时开放的情况，开门间隔规则在线网内应一致。"
  }
]
...
[
  ...
  },
  {
    "接口内容": "线路编号",
    "字节长度": "2",
    "说明": "线路编号,全网统一标识,默认值:0xFFFF"
  },
  {
    "接口内容": "车组号所属线路号",
    "字节长度": "2",
    "说明": "车组号所属线路号,默认值:0xFFFF"
  },
  {
    "接口内容": "车组号",
    "字节长度": "2",
    "说明": "二进制码,001~999 有效,000 表示对所有列车的广播,其他非法\n默认值:0xFFFF"
  },
  {
    "接口内容": "源线路号",
    "字节长度": "2",
    "说明": "列车始发站线路编号,默认值:0xFFFF"
  },
  {
    "接口内容": "车次号",
    "字节长度": "2",
    "说明": "0000~9999 有效,超出范围无效,0000 表示车次号未设定\n默认值:0xFFFF"
  },
  {
    "接口内容": "目的地线路号",
    "字节长度": "2",
    "说明": "目的地线路编号,默认值:0xFFFF"
  },
  {
    "接口内容": "目的地号",
    "字节长度": "4",
    "说明": "用 ASCII 码表示,具体定义内容在工程项目中明确默认值:0xFFFFFFF"
  },
  {
    "接口内容": "司机号",
    "字节长度": "2",
...
[
  {
    "接口内容": "区间运行调整命令",
    "字节长度": "2",
    "说明": "V0BC收到的ATS发送的运行等级或区间运行时间（列车从前一站发车到下一站停车时间，单位：s），根据业主需求确定，默认值：0xFFFF"
  },
  {
    "接口内容": "跳停状态",
    "字节长度": "1",
    "说明": "V0BC收到的ATS发送的跳停命令跳停：0x55无跳停命令/取消跳停：0xAA默认值：0xFF其他非法"
  },
  {
    "接口内容": "扣车状态",
    "字节长度": "1",
    "说明": "V0BC收到的ATS发送的扣车命令扣车有效：0x55扣车取消，无扣车：0xAA默认值：0xFF其他非法"
  },
  {
    "接口内容": "下一停车站台ID",
    "字节长度": "4",
    "说明": "V0BC收到的ATS发送的下一停车站台ID，默认值：0x00000000"
  },
  {
    "接口内容": "跳停站台ID",
    "字节长度": "4",
    "说明": "V0BC收到的ATS发送的跳停站台ID默认值：0x00000000"
  },
  {
    "接口内容": "扣车站台ID",
    "字节长度": "4",
    "说明": "V0BC收到的ATS发送的扣车站台ID默认值：0x00000000"
  },
  {
    "接口内容": "站停时间",
    "字节长度": "2",
    "说明": "V0BC收到的ATS发送的站停时间默认值：0xFFFF"
  },
  {
    "接口内容": "门控策略",
    "字节长度": "1",
    "说明": "V0BC收到的ATS发送的门控策略默认值：0xFF"
  },
  {
    "接口内容": "预留",
    "字节长度": "4",
  ...
  {
    "接口内容": "注：“车组号”、“车组号所属线路号”由V0BC通过“ATO状态信息帧”向ATS发送；ATS收到后，向车载发送的“ATO命令信息帧”中填写收到的“车组号”、“车组号所属线路号”，收到之前填写默认值；“ATO命令信息帧”中的其他信息由ATS通过“ATO命令信息帧”向V0BC发送；V0BC收到后，向ATS发送的“ATO状态信息帧”中填写已执行的对应信息值，收到之前填写默认值。当前ATO命令执行完成后，在新的命令到达之前，V0BC应持续向ATS反馈当前ATO命令的执行状态。",
    "字节长度": "注：“车组号”、“车组号所属线路号”由V0BC通过“ATO状态信息帧”向ATS发送；ATS收到后，向车载发送的“ATO命令信息帧”中填写收到的“车组号”、“车组号所属线路号”，收到之前填写默认值；“ATO命令信息帧”中的其他信息由ATS通过“ATO命令信息帧”向V0BC发送；V0BC收到后，向ATS发送的“ATO状态信息帧”中填写已执行的对应信息值，收到之前填写默认值。当前ATO命令执行完成后，在新的命令到达之前，V0BC应持续向ATS反馈当前ATO命令的执行状态。",
    "说明": "注：“车组号”、“车组号所属线路号”由V0BC通过“ATO状态信息帧”向ATS发送；ATS收到后，向车载发送的“ATO命令信息帧”中填写收到的“车组号”、“车组号所属线路号”，收到之前填写默认值；“ATO命令信息帧”中的其他信息由ATS通过“ATO命令信息帧”向V0BC发送；V0BC收到后，向ATS发送的“ATO状态信息帧”中填写已执行的对应信息值，收到之前填写默认值。当前ATO命令执行完成后，在新的命令到达之前，V0BC应持续向ATS反馈当前ATO命令的执行状态。"
  }
]
...
[
  ...
  },
  {
    "接口内容": "列车定位状态",
    "字节长度": "1",
    "说明": "有定位：0x55无定位：0xAA其他非法"
  },
  {
    "接口内容": "运行方向 $ ^{a} $",
    "字节长度": "1",
    "说明": "最小安全后端指向最大安全前端的方向，以最小安全后端处的上下行方向确定。上行：0x55下行：0xAA默认：0xFF其他：非法"
  },
  {
    "接口内容": "激活端",
    "说明": "本V0BC是否为激活端（首尾冗余的V0BC统一发送是激活端）激活端：0x55非激活端：0xAA其他：非法"
  },
  {
    "接口内容": "车轮转向",
    "字节长度": "1",
    "说明": "车轮正转（前进）：0x55车轮反转（后退）：0xAA其他值无效车轮不转动时按正转发送"
  },
  {
    "接口内容": "列车最大安全前端位置所在轨道区段ID $ ^{a} $",
    "字节长度": "4",
    "说明": "列车最大安全前端位置所在轨道区段ID默认值：0x00000000"
  },
  {
    "接口内容": "列车最大安全前端位置在轨道区段内偏移量 $ ^{a} $",
    "字节长度": "4",
    "说明": "单位：cm，有效范围：0x0~0xFFFFFFF默认值：0xFFFFFFF"
  }
]
...
[
  {
    "接口内容": "列车最小安全前端位置所在轨道区段ID*",
    "字节长度": "4",
    "说明": "列车最小安全前端位置所在轨道区段ID默认值:0x00000000"
  },
  {
    "接口内容": "列车最小安全前端位置在轨道区段内偏移量*",
    "字节长度": "4",
    "说明": "单位:cm,有效范围:0x0~0xFFFFFFF默认值:0xFFFFFFF"
  },
  {
    "接口内容": "列车最大安全后端位置所在轨道区段ID*",
    "字节长度": "4",
    "说明": "列车最大安全后端位置所在轨道区段ID默认值:0x00000000"
  },
  {
    "接口内容": "列车最大安全后端位置在轨道区段内偏移量*",
    "字节长度": "4",
    "说明": "单位:cm,有效范围:0x0~0xFFFFFFF默认值:0xFFFFFFF"
  },
  {
    "接口内容": "列车最小安全后端位置所在轨道区段ID*",
    "字节长度": "4",
    "说明": "列车最小安全后端位置所在轨道区段ID默认值:0x00000000"
  },
  {
    "接口内容": "列车最小安全后端位置在轨道区段内偏移量*",
    "字节长度": "4",
    "说明": "单位:cm,有效范围:0x0~0xFFFFFFF默认值:0xFFFFFFF"
  },
  {
    "接口内容": "列车驾驶模式*",
    "字节长度": "1",
    "说明": "AM模式:0x01CM模式:0x02RM模式:0x03EUM模式:0x04默认值:0xFF其他非法"
  },
  {
    "接口内容": "列车运行控制级别*",
    "字节长度": "1",
    "说明": "CBTC:0x01点式:0x02联锁:0x03默认值:0xFF其他非法"
  },
  {
    "接口内容": "列车完整性",
    "字节长度": "1",
    "说明": "完整:0x55不完整:0xAA其他非法"
  }
]
...
[
  {
    "接口内容": "列车紧急制动状态 $ ^{4} $",
    "字节长度": "1",
    "说明": "无紧急制动:0x55紧急制动:0xAA其他非法"
  },
  {
    "接口内容": "列车AR状态",
    "字节长度": "1",
    "说明": "列车换端过程中,原尾端ATP与ZC建立通信后到升级之前的状态处于AR状态:0x55未处于AR状态:0xAA其他非法"
  },
  {
    "接口内容": "列车速度信息",
    "字节长度": "2",
    "说明": "单位:cm/s,有效范围:0~15 000"
  },
  {
    "接口内容": "车门状态",
    "字节长度": "1",
    "说明": "开门:0x55关门:0xAA门旁路:0xFF其他非法若无门旁路功能则按照关门处理"
  },
  {
    "接口内容": "列车停稳状态",
    "字节长度": "1",
    "说明": "停稳且停准:0x55未停稳:0xAA停稳但未停准:0xCC其他:非法"
  },
  {
    "接口内容": "停车保证状态",
    "字节长度": "1",
    "说明": "停车保证响应可以停车:0x55无法停车:0xAA默认值:0xFF其他非法"
  },
  {
    "接口内容": "无人折返状态",
    "字节长度": "1",
    "说明": "无人折返折入中(从车载ATP接收到无人折返命令开始到换端前):0x55无人折返折出中:0xAA未在无人折返中:0x00默认值:0xFF其他非法若车载ATP无相关功能,则发送默认值;若ATS无相关功能,则可不处理此信息"
  }
]
...
[
  {
    "接口内容": "预选模式",
    "字节长度": "1",
    "说明": "车载 ATP 允许到达的最高模式CBTC - AM: 0x01CBTC - CM: 0x02ITC - AM: 0x03ITC - CM: 0x04IL - RM: 0x05其他值非法"
  },
  {
    "接口内容": "紧急制动原因",
    "字节长度": "1",
  ...
  },
  {
    "接口内容": "当前紧急制动触发速度",
    "字节长度": "2",
    "说明": "单位 cm/s, ATP 曲线对应的 EBI 速度,有效范围: 0x0~0xFFFE默认值: 0xFFFF。当 VOBC 无法发送此信息时, 发送默认值"
  },
  {
    "接口内容": "当前推荐速度",
    "字节长度": "2",
    "说明": "单位 cm/s, ATO 曲线对应的常用制动速度, 有效范围: 0x0~0xFFFE默认值: 0xFFFF。当 VOBC 无法发送此信息时, 发送默认值"
  },
  {
    "接口内容": "安全防护点轨道区段 ID $ ^{r} $",
    "字节长度": "4",
    "说明": "VOBC 采用的 ZC 的移动授权中的安全防护点轨道区段 ID默认值: 0x00000000"
  },
  {
    "接口内容": "安全防护点轨道区段偏移量 $ ^{r} $",
    "字节长度": "4",
    "说明": "VOBC 采用的 ZC 的移动授权中的安全防护点轨道区段偏移量。有效范围: 0x0~0xFFFFFFE默认值: 0xFFFFFFF"
  },
  {
    "接口内容": "障碍点轨道区段 ID $ ^{r} $",
    "字节长度": "4",
    "说明": "VOBC 采用的 ZC 的移动授权中的障碍点轨道区段 ID默认值: 0x00000000"
  },
  {
    "接口内容": "障碍点轨道区段内偏移量 $ ^{r} $",
    "字节长度": "4",
    "说明": "VOBC 采用的 ZC 的移动授权中的障碍点轨道区段偏移量。有效范围: 0x0~0xFFFFFFE默认值: 0xFFFFFFF"
  }
]
...
[
  {
    "接口内容": "道岔信息个数",
    "字节长度": "2",
    "说明": "V0BC采信的ZC的移动授权内包含的道岔个数。有效范围：0~20"
  },
  {
    "接口内容": "道岔(1)ID",
    "字节长度": "4",
  ...
  {
    "接口内容": "“若V0BC与ATS建立通信时无法确定准确位置，则“运行方向”、“列车最大安全前端位置所在轨道区段ID”、“列车最大安全前端位置在轨道区段内偏移量”、“列车最小安全前端位置所在轨道区段ID”、“列车最小安全前端位置在轨道区段内偏移量”、“列车最大安全后端位置所在轨道区段ID”、“列车最大安全后端位置在轨道区段内偏移量”、“列车最小安全后端位置所在轨道区段ID”、“列车最小安全后端位置在轨道区段内偏移量”均填写默认值。b“列车运行控制级别”与“列车驾驶模式”字段取值应满足下表对应关系，控制级别与驾驶模式对照见表24。若ATP采用ZC发送的MA，则安全防护点轨道区段ID、安全防护点轨道区段偏移量、障碍点轨道区段ID、障碍点轨道区段内偏移量取值均为采用的MA内容；",
    "字节长度": "“若V0BC与ATS建立通信时无法确定准确位置，则“运行方向”、“列车最大安全前端位置所在轨道区段ID”、“列车最大安全前端位置在轨道区段内偏移量”、“列车最小安全前端位置所在轨道区段ID”、“列车最小安全前端位置在轨道区段内偏移量”、“列车最大安全后端位置所在轨道区段ID”、“列车最大安全后端位置在轨道区段内偏移量”、“列车最小安全后端位置所在轨道区段ID”、“列车最小安全后端位置在轨道区段内偏移量”均填写默认值。b“列车运行控制级别”与“列车驾驶模式”字段取值应满足下表对应关系，控制级别与驾驶模式对照见表24。若ATP采用ZC发送的MA，则安全防护点轨道区段ID、安全防护点轨道区段偏移量、障碍点轨道区段ID、障碍点轨道区段内偏移量取值均为采用的MA内容；",
    "说明": "“若V0BC与ATS建立通信时无法确定准确位置，则“运行方向”、“列车最大安全前端位置所在轨道区段ID”、“列车最大安全前端位置在轨道区段内偏移量”、“列车最小安全前端位置所在轨道区段ID”、“列车最小安全前端位置在轨道区段内偏移量”、“列车最大安全后端位置所在轨道区段ID”、“列车最大安全后端位置在轨道区段内偏移量”、“列车最小安全后端位置所在轨道区段ID”、“列车最小安全后端位置在轨道区段内偏移量”均填写默认值。b“列车运行控制级别”与“列车驾驶模式”字段取值应满足下表对应关系，控制级别与驾驶模式对照见表24。若ATP采用ZC发送的MA，则安全防护点轨道区段ID、安全防护点轨道区段偏移量、障碍点轨道区段ID、障碍点轨道区段内偏移量取值均为采用的MA内容；"
  }
]
...
[
  {
    "接口内容": "报警信息数量",
    "字节长度": "1",
    "说明": "报警信息总数(n)，有效范围：8~20*"
  },
  {
    "接口内容": "信息1",
    "字节长度": "1",
    "说明": "ATO故障有故障：0x55无故障：0xAA默认值：0xFF其他值无效"
  },
  {
    "接口内容": "信息2",
    "字节长度": "1",
    "说明": "BTM故障有故障：0x55无故障：0xAA默认值：0xFF其他值无效"
  }
]
...
[
  {
    "接口内容": "信息3",
    "字节长度": "1",
    "说明": "车载人机界面故障有故障:0x55无故障:0xAA默认值:0xFF其他值无效"
  },
  {
    "接口内容": "信息4",
    "字节长度": "1",
    "说明": "雷达故障(可选)有故障:0x55无故障:0xAA默认值:0xFF其他值无效"
  },
  {
    "接口内容": "信息5",
    "字节长度": "1",
    "说明": "与列车信息管理系统通信故障有故障:0x55无故障:0xAA默认值:0xFF其他值无效"
  },
  {
    "接口内容": "信息6",
    "字节长度": "1",
    "说明": "测速传感器故障有故障:0x55无故障:0xAA默认值:0xFF其他值无效"
  },
  {
    "接口内容": "信息7",
    "字节长度": "1",
    "说明": "加速度计故障(可选)有故障:0x55无故障:0xAA默认值:0xFF其他值无效"
  },
  {
    "接口内容": "信息8",
    "字节长度": "1",
    "说明": "ATP故障(与ATS通信正常时)有故障:0x55无故障:0xAA默认值:0xFF其他:非法"
  },
  {
    "接口内容": "58",
    "字节长度": "58",
...
[
  ...
  {
    "接口内容": "“报警信息1~8为固定信息,其他报警信息可在具体工程中约定。",
    "字节长度": "“报警信息1~8为固定信息,其他报警信息可在具体工程中约定。",
    "说 明": "“报警信息1~8为固定信息,其他报警信息可在具体工程中约定。"
  }
]
...
[
  ...
  },
  {
    "信息域定义": "电子地图版本校验信息 $ ^{a} $",
    "字节编号": "11",
    "字段": "CI、VOBC之间的版本一致性信息",
    "长度": "4字节",
    "信息位定义及说明": "CI管辖范围内, CI与VOBC间的数据版本校验信息"
  },
  {
    "信息域定义": "电子地图版本校验信息 $ ^{a} $",
    "字节编号": "12",
...
[
  ...
  },
  {
    ...
    "字段": "协议版本号",
    "长度": "1字节",
    "信息位定义及说明": "CI-V0BC的协议版本,本规范定义为20"
  },
  {
    "信息域定义": "应用层报文总长度",
    "字节编号": "3031",
  ...
  {
    "信息域定义": "“电子地图版本校验信息针对范围为CI管辖区域范围。\n“序列号有效值为1~(211-1)。\n“当未收到对方消息时,序列号约定为0xFFFFFFF。\n““电子地图版本校验信息”、“协议版本号”需要进行校验,若校验不一致,则接收方进行丢包或断开安全连接处理。",
    "字节编号": "“电子地图版本校验信息针对范围为CI管辖区域范围。\n“序列号有效值为1~(211-1)。\n“当未收到对方消息时,序列号约定为0xFFFFFFF。\n““电子地图版本校验信息”、“协议版本号”需要进行校验,若校验不一致,则接收方进行丢包或断开安全连接处理。",
    "字段": "“电子地图版本校验信息针对范围为CI管辖区域范围。\n“序列号有效值为1~(211-1)。\n“当未收到对方消息时,序列号约定为0xFFFFFFF。\n““电子地图版本校验信息”、“协议版本号”需要进行校验,若校验不一致,则接收方进行丢包或断开安全连接处理。",
    "长度": "“电子地图版本校验信息针对范围为CI管辖区域范围。\n“序列号有效值为1~(211-1)。\n“当未收到对方消息时,序列号约定为0xFFFFFFF。\n““电子地图版本校验信息”、“协议版本号”需要进行校验,若校验不一致,则接收方进行丢包或断开安全连接处理。",
    "信息位定义及说明": "“电子地图版本校验信息针对范围为CI管辖区域范围。\n“序列号有效值为1~(211-1)。\n“当未收到对方消息时,序列号约定为0xFFFFFFF。\n““电子地图版本校验信息”、“协议版本号”需要进行校验,若校验不一致,则接收方进行丢包或断开安全连接处理。"
  }
]
...
[
  {
    "接口内容": "DIR_TRAIN",
    "字节长度": "1",
    "说明": "列车运行方向（激活端车头最大安全前端对应方向）上行：0x55下行：0xAA默认：0xFF"
  },
  {
    "接口内容": "CMD_UNLOCKOVERLAP",
    "字节长度": "1",
    "说明": "允许保护区段解锁命令允许解锁：0x55不允许解锁：0xAA其他非法列车在停车点停准停稳时（包含运营停车点，折返停车点，区间参考停车点），VOBC才可发出允许保护区段解锁命令"
  },
  {
    "接口内容": "NID_TRACK",
    "字节长度": "4",
    "说明": "轨道区段ID1~0xFFFFFFFF，0为默认值VOBC最大安全前端所在CI通信区段的轨道区段ID"
  },
  {
    "接口内容": "N_PSD_CMD_CODE",
    "字节长度": "1",
    "说明": "站台开门码，VOBC根据停准停稳时对应的停车点及列车编组信息向CI发送开门码，每个开门码对应CI需要开的一组站台门，站台开门码定义详见注4：默认值为0"
  }
]
...
[
  {
    "接口内容": "N_PSD",
    "字节长度": "1",
    "说明": "需要控制的PSD的数量(定长),0、1或者2;为0时,PSD1和PSD2字段填写默认值;为1时,PSD2字段填写默认值"
  },
  {
    "接口内容": "NID_PSD_1",
    "字节长度": "4",
    "说明": "PSD_1的ID1~0xFFFFFFFF0为默认值,表示当前通信位置不存在站台门"
  },
  {
    "接口内容": "NC_PSD_1",
    "字节长度": "1",
    "说明": "对PSD_1的控制命令(对应命令为开门时,开门码参照N_PSD_CMD_CODE)开门:0x55关门:0xAA默认无效值:0xFF"
  },
  {
    "接口内容": "NID_PSD_2",
    "字节长度": "4",
    "说明": "PSD_2的ID(用于实现不同侧的屏蔽门控制)1~0xFFFFFFFF0为默认值,表示当前通信位置不存在站台门"
  },
  {
    "接口内容": "NC_PSD_2",
    "字节长度": "1",
    "说明": "对PSD_2的控制命令(对应编组信息参照N_PSD_TYPE)开门:0x55关门:0xAA默认无效值:0xFF"
  },
  {
    "接口内容": "NID_SIGNAL",
    "字节长度": "4",
    "说明": "信号机的ID1~0xFFFFFFFF,0为默认值V0BC最大安全前端前方沿列车运行方向可搜索到的最近的同向信号机"
  },
  {
    "接口内容": "注1:在本接口中,CI根据V0BC发送的信号机ID回复对应的信号机状态。注2:V0BC发出允许保护区段解锁信息后,在自动或人工确认前方信号开放前,车载ATP应禁止列车前向牵引",
    "字节长度": "注1:在本接口中,CI根据V0BC发送的信号机ID回复对应的信号机状态。注2:V0BC发出允许保护区段解锁信息后,在自动或人工确认前方信号开放前,车载ATP应禁止列车前向牵引",
    "说明": "注1:在本接口中,CI根据V0BC发送的信号机ID回复对应的信号机状态。注2:V0BC发出允许保护区段解锁信息后,在自动或人工确认前方信号开放前,车载ATP应禁止列车前向牵引"
  }
]
...
[
  {
    "bit7": "上下行停车点: 0:下行; 1:上行",
    "bit6": "停车点定义 01b:停车点1 10b:停车点2",
    "bit5": "停车点定义 01b:停车点1 10b:停车点2",
    "bit4": "列车实际编组数。有效值:00001b~11111b。 例如,6编组列车取值为00110b",
    "bit3": "列车实际编组数。有效值:00001b~11111b。 例如,6编组列车取值为00110b",
    "bit2": "列车实际编组数。有效值:00001b~11111b。 例如,6编组列车取值为00110b",
    "bit1": "列车实际编组数。有效值:00001b~11111b。 例如,6编组列车取值为00110b",
    "bit0": "列车实际编组数。有效值:00001b~11111b。 例如,6编组列车取值为00110b"
  }
]
...
[
  ...
  {
    "接口内容": "注1：V0BC带有“注销请求帧”的GAL包中，应不带有其他信息包。注2：注销请求帧交互过程如下：(1)V0BC判断满足发送“注销请求帧”的条件后，应持续周期发送“注销请求帧”，直至收到CI发送的“注销回复帧”；(2)CI收到V0BC发送的“注销请求帧”后，应持续周期发送“注销回复帧”，直至与V0BC的通信断开；(3)V0BC收到CI发送的“注销回复帧”后，应停止发送“注销请求帧”，并断开与CI的通信；(4)4IPv0BC列车折返时，尾端V0BC应在明确获取首端V0BC已与CI注销或经过一定延时（应不小于V0BC-CI通信中断时间）后，方可向CI发送控制信息包。",
    "字节长度": "注1：V0BC带有“注销请求帧”的GAL包中，应不带有其他信息包。注2：注销请求帧交互过程如下：(1)V0BC判断满足发送“注销请求帧”的条件后，应持续周期发送“注销请求帧”，直至收到CI发送的“注销回复帧”；(2)CI收到V0BC发送的“注销请求帧”后，应持续周期发送“注销回复帧”，直至与V0BC的通信断开；(3)V0BC收到CI发送的“注销回复帧”后，应停止发送“注销请求帧”，并断开与CI的通信；(4)4IPv0BC列车折返时，尾端V0BC应在明确获取首端V0BC已与CI注销或经过一定延时（应不小于V0BC-CI通信中断时间）后，方可向CI发送控制信息包。",
    "说明": "注1：V0BC带有“注销请求帧”的GAL包中，应不带有其他信息包。注2：注销请求帧交互过程如下：(1)V0BC判断满足发送“注销请求帧”的条件后，应持续周期发送“注销请求帧”，直至收到CI发送的“注销回复帧”；(2)CI收到V0BC发送的“注销请求帧”后，应持续周期发送“注销回复帧”，直至与V0BC的通信断开；(3)V0BC收到CI发送的“注销回复帧”后，应停止发送“注销请求帧”，并断开与CI的通信；(4)4IPv0BC列车折返时，尾端V0BC应在明确获取首端V0BC已与CI注销或经过一定延时（应不小于V0BC-CI通信中断时间）后，方可向CI发送控制信息包。"
  }
]
...
[
  ...
  {
    "接口内容": "注1:CI与V0BC建立安全连接后，CI未收到V0BC发送的信息前，可周期发 送心跳帧（此功能不强制要求）。V0BC应可兼容CI发送的心跳帧“对方 清息序列号”、“收到上一条消息时本方序列号”字段取值为默认值。 注2:CI收到V0BC发送的首包信息，无法判断有效性时，发送“CI向V0BC发 送心跳帧”",
    "字节长度": "注1:CI与V0BC建立安全连接后，CI未收到V0BC发送的信息前，可周期发 送心跳帧（此功能不强制要求）。V0BC应可兼容CI发送的心跳帧“对方 清息序列号”、“收到上一条消息时本方序列号”字段取值为默认值。 注2:CI收到V0BC发送的首包信息，无法判断有效性时，发送“CI向V0BC发 送心跳帧”",
    "说明": "注1:CI与V0BC建立安全连接后，CI未收到V0BC发送的信息前，可周期发 送心跳帧（此功能不强制要求）。V0BC应可兼容CI发送的心跳帧“对方 清息序列号”、“收到上一条消息时本方序列号”字段取值为默认值。 注2:CI收到V0BC发送的首包信息，无法判断有效性时，发送“CI向V0BC发 送心跳帧”"
  }
]
...
[
  {
    "接口内容": "NID_TRACK",
    "字节长度": "4",
    "说明": "CI接收到的VOBC发送的轨道区段ID"
  },
  {
    "接口内容": "N_PSD_CMD_CODE",
    "字节长度": "1",
    "说明": "CI接收到的VOBC发送的站台开门码"
  },
  {
    "接口内容": "N_PSD",
    "字节长度": "1",
  ...
  },
  {
    "接口内容": "NID_PSD_1",
    "字节长度": "4",
    "说明": "PSD_1的ID,1~0xFFFFFFFF0为默认值,表示当前通信位置不存在站台门"
  },
  {
    "接口内容": "Q_PSD_1",
    "字节长度": "1",
    "说明": "PSD_1的状态开门:0x55关门:0xAA(互锁解除时按照关门发送)默认值:0xFF"
  },
  {
    "接口内容": "R_NC_PSD_1",
    "字节长度": "1",
    "说明": "CI接收到的VOBC对PSD_1的控制命令"
  },
  {
    "接口内容": "NID_PSD_2",
    "字节长度": "4",
    "说明": "PSD_2的ID1~0xFFFFFFFF0为默认值,表示当前通信位置不存在站台门"
  },
  {
    "接口内容": "Q_PSD_2",
    "字节长度": "1",
    "说明": "PSD_2的状态开门:0x55关门:0xAA(互锁解除时按照关门发送)默认值:0xFF"
  },
  {
    "接口内容": "R_NC_PSD_2",
    "字节长度": "1",
    "说明": "CI接收到的VOBC对PSD_2的控制命令"
  }
]
...
[
  {
    "接口内容": "Q_SIGNAL_ASPECT",
    "字节 长度": "4",
    "说 明": "信号机的 ID CI接收到的 V0BC 发送的信号机 ID"
  },
  {
    "接口内容": "Q_SIGNAL_ASPECT",
    "字节 长度": "1",
    "说 明": "“信号机的 ID”的信号机状态 点式允许信号:0x55 点式禁止信号:0xAA 默认值:0xFF(该方向无信号机时填写)"
  }
]
...
[
  ...
  {
    "列车位置及ATO控制命令帧发送更新时机": "注:表中,1、2……表示阶段定义中的各时刻,1—2、2—3……表示各时刻之间的时间段(不含两端的时刻),“—”表示该字段发送默认值。",
    "到站站台ID": "注:表中,1、2……表示阶段定义中的各时刻,1—2、2—3……表示各时刻之间的时间段(不含两端的时刻),“—”表示该字段发送默认值。",
    "跳停站台ID": "注:表中,1、2……表示阶段定义中的各时刻,1—2、2—3……表示各时刻之间的时间段(不含两端的时刻),“—”表示该字段发送默认值。",
    "下一停车站台ID": "注:表中,1、2……表示阶段定义中的各时刻,1—2、2—3……表示各时刻之间的时间段(不含两端的时刻),“—”表示该字段发送默认值。",
    "下一站跳停命令": "注:表中,1、2……表示阶段定义中的各时刻,1—2、2—3……表示各时刻之间的时间段(不含两端的时刻),“—”表示该字段发送默认值。",
    "站停时间": "注:表中,1、2……表示阶段定义中的各时刻,1—2、2—3……表示各时刻之间的时间段(不含两端的时刻),“—”表示该字段发送默认值。",
    "区间运行调整命令": "注:表中,1、2……表示阶段定义中的各时刻,1—2、2—3……表示各时刻之间的时间段(不含两端的时刻),“—”表示该字段发送默认值。"
  }
]

[
  {
    "列车位置及ATO 控制命令帧发送 更新时机各 阶段定义": "1.A进站",
    "各阶段定义": "ATS收到列车信息帧中的安全防护点轨道区段ID和偏移量， 即列车最大安全前端到达A站站台的时刻"
  }
]
...
[
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "2. A停稳",
    "各阶段定义": "ATS开始收到列车信息帧中的停稳状态字段内容为0x55的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "3. A开车",
    "各阶段定义": "ATS开始收到列车信息帧中的停稳状态字段内容不为0x55的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "4. A出站",
    "各阶段定义": "列车最大安全前端离开A站站台的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "5. B进站",
    "各阶段定义": "列车最大安全前端到达B站站台的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "6. B越过停车点",
    "各阶段定义": "列车最大安全前端越过B站停车点的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "7. B出站",
    "各阶段定义": "列车最大安全前端离开B站站台的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "8. C进站",
    "各阶段定义": "列车最大安全前端到达C站站台的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "9. C越过停车点",
    "各阶段定义": "列车最大安全前端越过C站停车点的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "10. C出站",
    "各阶段定义": "列车最大安全前端离开C站站台的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "11. D进站",
    "各阶段定义": "ATS收到列车信息帧中的安全防护点轨道区段ID和偏移量，即列车最大安全前端到达D站站台的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "12. D停稳",
    "各阶段定义": "ATS开始收到列车信息帧中的停稳状态字段内容为0x55的时刻"
  },
  {
    "列车位置及ATO控制命令帧发送更新时机各阶段定义": "注: 表中,1,2……表示阶段定义中的各时刻。",
    "各阶段定义": "注: 表中,1,2……表示阶段定义中的各时刻。"
  }
]
