...
[
  {
    "Unacceptable region": "The ALARP or tolerability region (Risk is undertaken only if a benefit is desired)",
    "Risk cannot be justi ncept in extraordin circumstances": "Tolerable only if risk reduction is impracti b or if cost is grossly disproporti onate to th i mprovement gained"
  },
  {
    "Unacceptable region": "Broadly acceptable region (No need for detailed working to demonstrate ALARP)",
    "Risk cannot be justi ncept in extraordin circumstances": "Tolerable if cost of reduction w exceed the improvement gain"
  }
]
...
[
  {
    ...
    "Description of safety integrity": "Very High Integrity"
  },
  {
    "Safety integrity level": "3",
    "Description of safety integrity": "Increasing rigour and effectiveness of methods"
  },
  {
  ...
  },
  {
    ...
    "Description of safety integrity": "Basic Integrity"
  }
]
