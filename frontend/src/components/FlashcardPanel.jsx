...
import { X, Lightbulb, RotateCcw, Check, ArrowRight, Plus } from 'lucide-react';
          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            {showCreateForm && (
              <motion.div
                ...
                className="mb-4 p-4 bg-google-blue-50 rounded-lg border border-google-blue-200"
              >
                <h3 className="font-medium text-google-gray-900 mb-3">创建新闪卡</h3>
                <div className="space-y-3">
                  <div>
                    <label className="block text-sm font-medium text-google-gray-700 mb-1">
                      问题（正面）
                    </label>
                    <textarea
                      value={newCard.front}
                      ...
                      className="w-full px-3 py-2 border border-google-gray-300 rounded-lg 
                               focus:outline-none focus:ring-2 focus:ring-google-blue-500 resize-none"
                      rows="2"
                      placeholder="输入问题..."
                    />
                  </div>
