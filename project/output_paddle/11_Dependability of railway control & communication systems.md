...
- Reliability - the probability that the item will deliver its required function when required.

- Availability - the proportion of time for which the item is in a state to perform its required function.
...
- Preventive Maintenance - to keep the item safe and reliable (usually on a predetermined schedule).
...
○ Often measured as Mean Time Between Failures (MTBF). This formula gives a good approximation

○ MTBF = Length of Time / Number of Failures in that time
...
☐ This will typically be measured in years for elements of a railway system (e.g. radio transmitter, track circuit), but lower for whole systems.

MTTF (Mean Time To Failure) is a very similar measure used for non-repairable systems
...
## I mpact on Safety of Reliability & Availability
...
## I mproving ‘Wear-out’ Period Reliability
...
## Dependability Measurement (Operations Phase)
